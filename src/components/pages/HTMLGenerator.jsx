...
function HTMLGenerator (props) {
  ...
  function tileGenerate (inputData) {
    ...
    ${inputData.selectedTile == "Small Tile" ? `<div class="u-columns__column u-columns__column--six-s todo-item lmdd-block u-columns__column--three-l">` : inputData.selectedTile == "Large Tile" ? `<div class="u-columns__column u-columns__column--six-s todo-item lmdd-block u-columns__column--six-l">` : ``}  
          ...
          ${inputData.selectedTile == "Small Tile" ? `<div class="c-tile-top u-bg-white c-tile u-aspect-one-by-one u-aspect-eight-by-nine-m">` : inputData.selectedTile == "Large Tile" ? `<div class="c-tile-top u-bg-white c-tile u-aspect-nine-by-eight u-aspect-eight-by-nine-m u-aspect-sixteen-by-nine-l">` : ``}
  ...
  return (
    <center style={{padding: "1rem"}}>
      ...
      <button className='copyButton'
        onClick={() =>  
        navigator.clipboard.writeText(output.replace("\\s", "")) && alert('Output Copied to Clipboard')
        }
      >
        Copy Output
      </button>
